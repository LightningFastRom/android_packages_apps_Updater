 ...
 */
public class HapticSpinner extends Spinner {
    public HapticSpinner(Context context) {
        super(context);
        initVibration(context);
    }

    public HapticSpinner(Context context, AttributeSet attrs) {
        super(context, attrs);
        initVibration(context);
    }

    public HapticSpinner(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        initVibration(context);
    }

    public HapticSpinner(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
