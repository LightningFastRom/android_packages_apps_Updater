 ...
 */
public class HapticSwitch extends Switch {
    public HapticSwitch(Context context) {
        super(context);
        initVibration(context);
    }

    public HapticSwitch(Context context, AttributeSet attrs) {
        super(context, attrs);
        initVibration(context);
    }

    public HapticSwitch(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        initVibration(context);
    }

    public HapticSwitch(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
